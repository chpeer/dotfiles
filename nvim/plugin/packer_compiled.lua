...
_G.packer_plugins = {
  ["Comment.nvim"] = {
    loaded = true,
    path = "/home/christian/.local/share/nvim/site/pack/packer/start/Comment.nvim",
  ...
  ["cmp-nvim-lua"] = {
    loaded = true,
    path = "/home/christian/.local/share/nvim/site/pack/packer/start/cmp-nvim-lua",
  ...
  ["git-conflict.nvim"] = {
    loaded = true,
    path = "/home/christian/.local/share/nvim/site/pack/packer/start/git-conflict.nvim",
  ...
  ["lsp_signature.nvim"] = {
    loaded = true,
    path = "/home/christian/.local/share/nvim/site/pack/packer/start/lsp_signature.nvim",
  ...
  ["marks.nvim"] = {
    loaded = true,
    path = "/home/christian/.local/share/nvim/site/pack/packer/start/marks.nvim",
  ...
  ["nvim-dap-virtual-text"] = {
    loaded = true,
    path = "/home/christian/.local/share/nvim/site/pack/packer/start/nvim-dap-virtual-text",
  ...
  ["papercolor-theme-slim"] = {
    config = { "\27LJ\2\n>\0\0\3\0\3\0\0056\0\0\0009\0\1\0'\2\2\0B\0\2\1K\0\1\0\31colorscheme PaperColorSlim\bcmd\bvim\0" },
    loaded = true,
    path = "/home/christian/.local/share/nvim/site/pack/packer/start/papercolor-theme-slim",
    url = "https://github.com/pappasam/papercolor-theme-slim"
  },
  ["please.nvim"] = {
    loaded = true,
    path = "/home/christian/.local/share/nvim/site/pack/packer/start/please.nvim",
    url = "https://github.com/marcuscaisey/please.nvim"
  },
  ["plenary.nvim"] = {
    loaded = true,
  ...
  ["telescope-fzf-native.nvim"] = {
    loaded = true,
    path = "/home/christian/.local/share/nvim/site/pack/packer/start/telescope-fzf-native.nvim",
  ...
  ["vim-tmux-navigator"] = {
    loaded = true,
    path = "/home/christian/.local/share/nvim/site/pack/packer/start/vim-tmux-navigator",
    url = "https://github.com/christoomey/vim-tmux-navigator"
  }
}

time([[Defining packer_plugins]], false)
-- Config for: papercolor-theme-slim
time([[Config for papercolor-theme-slim]], true)
try_loadstring("\27LJ\2\n>\0\0\3\0\3\0\0056\0\0\0009\0\1\0'\2\2\0B\0\2\1K\0\1\0\31colorscheme PaperColorSlim\bcmd\bvim\0", "config", "papercolor-theme-slim")
time([[Config for papercolor-theme-slim]], false)
